...
description: Act as a technical lead to analyze requirements, design Spring Boot solutions (gdtracker-api), break work into delegable tasks, coordinate sub-work, and review results. Use when the user needs architecture, planning, task breakdown, delegation, or workflow coordination.
---
