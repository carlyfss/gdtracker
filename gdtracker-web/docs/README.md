...
| Topic   | Choice                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Layout  | Full-width shell with **16px** horizontal inset on the top header and main content (see [`src/App.css`](../src/App.css)); game routes also include a **67px** left icon sidebar (Dashboard / Heatmap / Tasks / Integration / Configuration) that fills the available height below the header. Sidebar labels appear as overlay tooltips on hover/focus (no layout shift). `.appShell` is a column flex layout with a flat page background so the body fills the viewport below the header. Game dashboard sections use `.gamePageSection` / `.gamePageStack` instead of floating `.card` panels. Games hub column scales with `.gamesHub`. |
