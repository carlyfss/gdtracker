...
| Topic   | Choice                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Layout  | **Desktop (≥768px):** full-width shell with **16px** main padding and a **64px icon sidebar** (Games, game sections, Log out). Sidebar labels use hover/focus tooltips. **Mobile (&lt;768px):** top **header** with hamburger menu, **breadcrumbs**, and a **nav drawer** (labeled links); sidebar hidden; main content full width. Breakpoint tokens in [`src/styles/breakpoints.css`](../src/styles/breakpoints.css). Game sections use `.gamePageSection` / `.gamePageStack`. Tasks use **card rows** on small screens; filters collapse behind a compact **Show/Hide filters** control (stacked label → add select → pills when open; task list stays visible below). |
