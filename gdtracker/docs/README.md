...
| `src/components/` | `ProtectedRoute`, `GameDashboardLayout` (header nav + outlet), shared UI (`TaskDescriptionMarkdown`, `DashboardFeatureTreePanel`, `FeatureTasksModal`, `TagTasksModal`)                  |
| `src/pages/`      | `LoginPage`, `GamesHubPage`, `GameCreatePage`, plus dashboard pages (`DashboardPage`, `HeatmapPage`, `TasksPage`, `ArchivePage`, `FeedbackPage`, `IntegrationPage`, `ConfigurationPage`) |
